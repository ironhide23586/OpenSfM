...
def shot_to_json(shot, ref_lla=None):
    """
    ...
    obj['gps_position'] = list(map(float, translation_lla))
...
def reconstruction_to_json(reconstruction, ref_lla=None):
    """
    ...
    for shot in reconstruction.shots.values():
        obj['shots'][shot.id] = shot_to_json(shot, ref_lla=ref_lla)
...
def reconstructions_to_json(reconstructions, ref_lla=None):
    """
    Write all reconstructions to a json object
    """
    return [reconstruction_to_json(i, ref_lla=ref_lla) for i in reconstructions]
